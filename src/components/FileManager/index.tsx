...
const FileManager: React.FC<FileManagerProps> = ({ countryName, onClose }) => {
  ...
  const sampleFiles: FileItem[] = [
    {
      id: '1',
      name: 'Prototype Control of NA Products.pdf',
      type: 'pdf',
      size: '2.3 MB',
    ...
    {
      id: '2',
      name: 'WHP PH NA CARRIER FAI Standard Process.docx',
      type: 'doc',
      size: '8.5 MB',
    ...
    {
      id: '3',
      name: 'WPC Project OK2P Readiness Workflow.pdf',
      type: 'pdf',
      size: '1.2 MB',
    ...
    {
      id: '4',
      name: 'NPI Phone Label Standardization.pdf',
      type: 'pdf',
      size: '3.4 MB',
    ...
    {
      id: '5',
      name: 'WPC Project Handbook Guidance.xlsx',
      type: 'excel',
      size: '12.4 MB',
    ...
    {
      id: '6',
      name: 'Prototype Build Working Guidance.xlsx',
      type: 'excel',
      size: '2.4 MB',
